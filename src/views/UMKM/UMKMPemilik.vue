<template>
  <div class="w-full min-h-screen flex flex-col bg-[#fafafa]">
    <HeaderForm title="Tambah Pemilik Usaha" @back="handleBack" />

    <div class="flex-1 flex flex-col">
      <div class="bg-white rounded-xl mx-4 md:mx-8 lg:mx-16 xl:mx-24 mt-4 p-4 md:p-6">
        <div class="relative mb-3">
          <InfoAlert>
            Tiap usaha dapat dimiliki lebih dari satu orang. Pemilik usaha harus merupakan warga yang sudah terdaftar di
            aplikasi.
          </InfoAlert>
          <div class="relative">
