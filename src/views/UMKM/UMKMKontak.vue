        ...
        <div v-if="showModal" class="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
            <div class="bg-white rounded-xl p-4 md:p-6 w-[90vw] max-w-md">
                <div class="mb-3">
                    ...
                    <select v-model="selectedTipe"
                        class="w-full border rounded-lg px-3 py-2 md:px-4 md:py-3 text-sm md:text-base">
                ...
                <div class="flex gap-2 justify-end">
                    <button @click="showModal = false"
                        class="px-4 py-2 rounded bg-gray-200 text-sm md:text-base">Batal</button>
                    <button @click="addKontak" :disabled="!selectedTipe || !inputKontak"
                        class="px-4 py-2 rounded bg-[#00c48c] text-white text-sm md:text-base">Tambah</button>
                </div>
            </div>
        </div>
    </div>
